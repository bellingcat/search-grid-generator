    ...
    methods: {
        ...
        onManualCoordsChange(lat1, lng1, lat2, lng2) {
            ...
            if (lat1 && lng1 && lat2 && lng2) {
                const customPoly = createPolygonFromBbox(
                    lng1,
                    lat1,
                    lng2,
                    lat2,
                ...
                this.gridGeoJson = L.geoJSON(grid, { ...gridstyle }).setStyle(
                    gridstyle,
                );
        ...
        updateGrid() {
            ...
            if (error) {
                alert(
                    'An error has occurred. Check the grid size or the polygon shape.',
                );
                return;
            }
            const gridstyle = {
